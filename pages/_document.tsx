...
fbq('track', 'PageView'); `
          ...
          {process.env.NODE_ENV == "production" &&
            process.env.SENTRY_TRACKING_ID && (
              <>
                <script
                ...
                <script
                  dangerouslySetInnerHTML={{
                    __html: `Raven.config('https://${
                      process.env.SENTRY_TRACKING_ID
                    }@sentry.io/156600').install()`
                  }}
                />
              </>
            )}
